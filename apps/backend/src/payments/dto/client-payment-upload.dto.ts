...
export class ClientPaymentUploadDto {
  @ApiPropertyOptional({
    description:
      'Project ID for the payment. Required if invoiceId is not provided.',
  ...
  @ApiPropertyOptional({
    description:
      'Invoice ID if payment is for a specific invoice. Project ID will be fetched from invoice.',
    example: '123e4567-e89b-12d3-a456-426614174000',
  })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description:
      'Type of payment. If not provided, will be inferred from invoiceId.',
    enum: PaymentType,
