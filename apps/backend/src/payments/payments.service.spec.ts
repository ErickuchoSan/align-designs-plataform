...
describe('PaymentsService', () => {
    ...
    describe('createClientPayment', () => {
        ...
        it('should create pending payment for client', async () => {
            ...
            const pendingPayment = {
                ...
                fromUser: { id: mockUserId, firstName: 'Client', lastName: 'Name', email: 'c@test.com' }, // Ensure fromUser exists for notification
            };
    ...
    describe('approvePayment', () => {
        it('should approve payment and update project status', async () => {
            const pendingPayment = { ...mockPayment, status: PaymentStatus.PENDING_APPROVAL };
    ...
    describe('rejectPayment', () => {
        it('should reject payment', async () => {
            ...
            const result = await service.rejectPayment(mockPaymentId, 'admin-id', 'Invalid receipt');
    ...
    describe('getReceiptDownloadUrl', () => {
        it('should return presigned url', async () => {
            const paymentWithReceipt = { ...mockPayment, receiptFileUrl: 'path/to/receipt.pdf' };
            ...
            expect(storageService.getDownloadUrl).toHaveBeenCalledWith('path/to/receipt.pdf');
        });
    });
});
