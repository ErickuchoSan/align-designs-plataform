import { IsNotEmpty, IsString, MaxLength, MinLength, IsOptional, IsEnum } from 'class-validator';
...
export class CreateCommentDto {
  ...
  @ApiPropertyOptional({ enum: Stage, description: 'Stage where the comment belongs' })
  @IsOptional()
