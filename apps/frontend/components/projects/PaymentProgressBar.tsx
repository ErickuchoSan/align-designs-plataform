    ...
    <div className={`space-y-2 ${className}`}>
      <div className="flex justify-between text-sm">
        <span className="text-gray-600">
          Pagado: <span className="font-semibold text-gray-900">${paid.toFixed(2)}</span>
        </span>
        <span className="text-gray-600">
          Requerido: <span className="font-semibold text-gray-900">${required.toFixed(2)}</span>
        </span>
      </div>
      ...
      <div className="flex justify-between text-xs text-gray-500">
        ...
        {!isComplete && <span>Restante: ${remaining.toFixed(2)}</span>}
