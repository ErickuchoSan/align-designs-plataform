              ...
              <div className="flex flex-wrap gap-2 pt-3 border-t border-stone-200">
                {file.filename && (
                  <>
                    <button
                      onClick={() => onDownload(file.id, file.originalName!)}
                      className="flex-1 min-w-[calc(50%-0.25rem)] flex items-center justify-center gap-1.5 px-3 py-2 text-xs font-medium text-stone-600 hover:text-navy-600 hover:bg-stone-50 rounded-lg transition-colors border border-stone-200"
                    >
                    ...
                    <button
                      onClick={() => onViewHistory(file)}
                      className="flex-1 min-w-[calc(50%-0.25rem)] flex items-center justify-center gap-1.5 px-3 py-2 text-xs font-medium text-stone-600 hover:text-blue-600 hover:bg-stone-50 rounded-lg transition-colors border border-stone-200"
                    >
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                      </svg>
                    ...
                    <button
                      onClick={() => onUploadVersion(file)}
                      className="flex-1 min-w-[calc(50%-0.25rem)] flex items-center justify-center gap-1.5 px-3 py-2 text-xs font-medium text-stone-600 hover:text-green-600 hover:bg-stone-50 rounded-lg transition-colors border border-stone-200"
                    >
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12" />
                      </svg>
                ...
                <button
                  onClick={() => onEdit(file)}
                  className="flex-1 min-w-[calc(50%-0.25rem)] flex items-center justify-center gap-1.5 px-3 py-2 text-xs font-medium text-stone-600 hover:text-gold-600 hover:bg-stone-50 rounded-lg transition-colors border border-stone-200"
                >
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                  </svg>
                ...
                {canDelete(file) && (
                  <button
                    onClick={() => onDelete(file)}
                    className="flex-1 min-w-[calc(50%-0.25rem)] flex items-center justify-center gap-1.5 px-3 py-2 text-xs font-medium text-stone-600 hover:text-red-600 hover:bg-stone-50 rounded-lg transition-colors border border-stone-200"
                  >
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
                    </svg>
