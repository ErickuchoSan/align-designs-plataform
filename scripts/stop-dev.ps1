...
# Autor: Claude Code
# Descripción: Detiene todos los procesos de Node.js relacionados con el proyecto
...
if ($stopped) {
    ...
    Write-Host "  ℹ️  No se encontraron servicios activos  " -ForegroundColor Yellow
    Write-Host "========================================" -ForegroundColor Yellow
}
